...
const avatarPop: Variants = {
  ...
  visible: {
    ...
    transition: {
      ...
      stiffness: 120,
      damping: 20,
      delay: 0.3, // Muncul tepat setelah nama
    },
  },
};
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex justify-center md:justify-end relative">
            <div className="relative w-75 h-75 md:w-100 md:h-100 flex items-center justify-center mt-12 md:mt-0">
              ...
              {/* Lingkaran Tengah - Ripple 2 (0.5s) */}
              <motion.div custom={0.5} variants={circleRipple} initial="hidden" animate="visible" className="absolute w-[80%] h-[80%] rounded-full bg-[#2a4518]" />

              {/* Lingkaran Dalam - Ripple 3 (0.6s) */}
              <motion.div custom={0.6} variants={circleRipple} initial="hidden" animate="visible" className="absolute w-[60%] h-[60%] rounded-full bg-primary" />
